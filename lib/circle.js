...
function Circle(text, textColor, backgroundColor) {
...
Circle.prototype.generateSVG = function() {
  ...
  <text x="150" y="120" text-anchor="middle" font-size="20" fill="${this.textColor}">
    <tspan font-family="Times New Roman" font-weight="bold" font-size="4rem">${this.text}</tspan>
  </text>
  </svg>`;
}
